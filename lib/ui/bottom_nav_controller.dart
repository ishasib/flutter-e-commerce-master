...
import 'package:flutter_ecommerce/const/AppColors.dart'; // Assuming AppColors.dart defines colors
...
class _BottomNavControllerState extends State<BottomNavController> {
  ...
  int _currentIndex = 0; // Using 'int' for consistency
